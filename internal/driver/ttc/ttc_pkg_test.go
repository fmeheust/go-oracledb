...
var testCases = []oracleTest.CategorizedTestCase{
	...
	{Name: "TestClientSessionlessTransactionRequiresWrapperAccess", Categories: "unitary", Exclusive: false, Fn: TestClientSessionlessTransactionRequiresWrapperAccess},
	{Name: "TestSessionlessTransactionAccessAllowsServerOriginatedSQL", Categories: "unitary", Exclusive: false, Fn: TestSessionlessTransactionAccessAllowsServerOriginatedSQL},
