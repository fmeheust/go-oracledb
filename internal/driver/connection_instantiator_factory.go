...
import (
	...
	"github.com/oracle/go-oracledb/internal/driver/ttc"
...
func GetConnectionInstantiator(config *oracleconfig.OracleDriverConfig, ns *session.NetworkSession) (common.ConnectionInstantiator, error) {
