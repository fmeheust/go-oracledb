...
Application code should import and depend on `github.com/oracle/go-oracledb/oracle`.
Packages under `github.com/oracle/go-oracledb/driver/...` are implementation details
